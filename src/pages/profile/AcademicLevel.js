                              ...
                              <div className="row">
                                <div className="form-group col-lg-4">
                                  ...
                                  <input
                                    ...
                                    className={'form-control'}
                                    rows={5}
                                    name={`academicInfo.${index}.date`}
                                    onChange={(e) => handleChange(`academicInfo.${index}.date`)(e)}
                                    value={values.academicInfo[index].date}
                                  />
                                </div>
                              </div>
                              <div className="row">
                                <div className="form-group col-lg-12">
                                  ...
                                  <textarea
                                    className={'form-control'}
                                    rows={5}
                                    name={`academicInfo.${index}.note`}
                                    onChange={(e) => handleChange(`academicInfo.${index}.note`)(e)}
                                    value={values.academicInfo[index].note}
                                  />
                                </div>
                              </div>
                              <div className="row">
